               ...
               <div class="row mt-3 mx-auto">
                  <div class="col-lg-12 border rounded border-1 shadow-sm p-4 bg-white">
                     <div class="d-flex justify-content-between align-items-center mb-3">
                     	...
                     	<a href="<%=request.getContextPath()%>/admin/add-patient.jsp" class="btn btn-second">Add appointment</a>
                     </div>
                     <table class="table table-striped table-hover">
                        ...
                        <tbody>
                           <%
                              List<Appointment> listAppointment = (List<Appointment>) request.getAttribute("listAppointments");
                           ...
                           <tr>
                              ...
                              <td><%= app.getAmount() %></td>
                              <td>
                                 <a href="<%=request.getContextPath()%>/showEditForm?id=<%= app.getAppID() %>" type="button" class="p-1 rounded bg-primary text-white" >
                                 	<i class="ri-pencil-line"></i>
                                 </a>
                                 <a href="<%=request.getContextPath()%>/deltePatient?id=<%= app.getAppID() %>" class="p-1 rounded bg-danger text-white" >
