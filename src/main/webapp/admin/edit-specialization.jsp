            ...
            <main class="main px-3 mt-5">
               ...
               <div class="row mt-3 mx-auto">
                  <div class="col-lg-12 border rounded border-1 shadow-sm p-4 bg-white">
                     ...
                     <form action="<%=request.getContextPath()%>/editSpec" method="post" class="mt-5 needs-validation row" novalidate>
                     <input type="hidden" name="id" value="${spect.specializationID}" />
                        <div class="col-md-5 mb-3">
                           <label for="specName" class="form-label">specialization Name</label>
                           <input type="text" class="form-control" id="specName" name="specName" value="${spect.spcName}" required  />
                        </div>
                        <div class="col-lg-12 mb-3">
                           ...
                           <textarea
                              ...
                              name="specDecs"
                              style="height: 100px"
                              >${spect.spcDec}</textarea>
                        </div>
                        <button type="submit" class="btn btn-main mb-3">Save Changes</button>
                     </form>
                  </div>
               </div>
            </main>
