               ...
               <div class="row mt-3 mx-auto">
                  <div class="col-lg-12 border rounded border-1 shadow-sm p-4 bg-white">
                     <div class="d-flex justify-content-between align-items-center mb-3">
                     	...
                     	<a href="<%=request.getContextPath()%>/admin/add-doctor.jsp" class="btn btn-second">Add Doctor</a>
                     </div>
                     <table class="table table-striped table-hover">
                        ...
                        <tbody>
                        	...
                        	<tr>
                                    ...
                                    <td>
                                        <c:out value="${doctor.dob}" />
                                    </td>
                                    <td>
                                        <c:out value="${doctor.address}" />
                                    </td>
                                    <td>
                                        <c:out value="${doctor.phoneNo}" />
                                    </td>
                                    <td>
                                        <c:out value="${doctor.email}" />
                                    </td>
                                    <td>
                                        <c:out value="${doctor.reg_date}" />
                                    </td>
									<td>
	                                 <a href="<%=request.getContextPath()%>/showDoctorEditForm?id=${doctor.doctorID}" type="button" class="p-1 rounded bg-primary text-white" >
                                 	<i class="ri-pencil-line"></i>
                                 </a>
                                 <a href="<%=request.getContextPath()%>/delteDoctor?id=${doctor.doctorID}" class="p-1 rounded bg-danger text-white" >
