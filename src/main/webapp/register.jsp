        ...
        <div class="col-lg-12">
          <div class="register-box p-5">
            <div class="d-flex d-flex align-items-center justify-content-between">
	            ...
	            <a href="<%=request.getContextPath()%>/doctor/doctor-register.jsp">Are you a Doctor?</a>
            </div>
            <p>Register by entering the information below</p>
            <form action="patientRegister" method="post" class="mt-5 needs-validation" novalidate>
              <div class="row">
