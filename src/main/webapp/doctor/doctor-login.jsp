    ...
    <div class="container-fluid login d-flex align-items-center justify-content-center" >
      <div class="row">
        <div class="col-lg-12">
          ...
          <h2>Doctor Login</h2>
            <form action="<%= request.getContextPath() %>/doctorLogin" method="post" class="mt-3 needs-validation" novalidate>
            ...
            <!-- Register buttons -->
              <div class="text-center">
                <p>Not a member? <a href="<%=request.getContextPath()%>/doctor/doctor-register.jsp">Register</a></p>
                <hr />
                <a href="<%=request.getContextPath()%>/login.jsp">Patient Login</a>
