    ...
    private void updatePatient(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if ("admin".equals(adminUsername)) {
                response.sendRedirect("listPatients"); // Redirect to the admin dashboard
            } else {
                response.sendRedirect("patient/profile-settings.jsp"); // Redirect to the patient dashboard
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
